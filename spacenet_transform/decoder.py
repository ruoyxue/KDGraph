...
class Decoder:
    ...
    def vectorization_decode(location, direction, distance_range=[30, 448], point_line_distance=[50, 140]):
        ...
        for batch in range(batch_size):
            adjacency_matrix[batch, :, :] = VectorizationDecoder.calculate_adjacency_matrix(
...
class VectorizationDecoder:
    @staticmethod
    def calculate_adjacency_matrix(location, direction, distance_range=[30, 448], point_line_distance=[50, 140]):
        """
